	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li><i class="icon-envelope-l"></i>Products</li>
			</ol>
		</div>
	</div>
	  ...
	  <table class="table table-striped table-advance table-hover">
	   <tbody>
	      <tr>
	         ...
	         <th><i class="icon-envelope-l"></i> Statu</th>
...
?>
	      ...
	      <tr>
	         ...
	         <td>
	          <div class="btn-group">
	              <a class="btn btn-primary" href="product.php?edit=<?=$value['id']?>"><i class="icon_document"></i></a>
	              <a class="btn btn-success" href="product.php?view=<?=$value['id']?>"><i class="icon_check_alt2"></i></a>
	              <a class="btn btn-danger" href="product.php?delete=<?=$value['id']?>"><i class="icon_close_alt2"></i></a>
	          </div>
	         </td>
	      </tr>
