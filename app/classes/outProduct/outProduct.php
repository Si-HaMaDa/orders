<?php namespace classes\OutProduct;
...
* OutProducts class
*/
class OutProduct extends Eloquent
{
	...
	public function deleteee($del)
	{
		if ($this::where('id', $del)->delete()){
			echo "<script>alert('Out Product has been deleted successfully');window.location='outproducts.php';</script>";
	...
	public function saveData()
	{
		...
		if (!empty($this->errors)) {
  	 	...
  	 	if ($this->save()){
  	 		echo "<script>alert('Out Product successfully added');window.location='outproducts.php';</script>";
  	 	} else { return false;}
	...
	public function updateee($edit)
	{
		...
		{
			echo "<script>alert('Done');window.location='outproducts.php';</script>";
		}
